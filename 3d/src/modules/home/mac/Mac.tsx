...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  useFrame(() => {
    if (clockRef.current.running) {
      ...
      const ratio = Math.min(delta * 4, 1);

      const rotationVectorLerp = currentRotation.clone().lerp(targetRotation, ratio);
      ...
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <mesh geometry={nodes.defaultMaterial.geometry}
                material={materials.apple_a1708_macbook_pro_13_mpxq2ua_space_gray_decol_mat}/>
          <mesh geometry={nodes.defaultMaterial_1.geometry}
                material={materials.apple_a1708_macbook_pro_13_mpxq2ua_space_gray_decol_mat}/>
          <mesh geometry={nodes.defaultMaterial_2.geometry}
                material={materials.apple_a1708_macbook_pro_13_mpxq2ua_space_gray_main_mat}/>
